package de.voldechse.wintervillage.proxy.util;
    ...
    public UUID uuidFrom(String name) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                InjectionLayer.ext().instance(Proxy.class).getInstance().getLogger().severe("Could not find uuid from " + name);
                return null;
            }
    ...
    public String stringFrom(UUID uuid) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                InjectionLayer.ext().instance(Proxy.class).getInstance().getLogger().severe("Could not find name from " + uuid);
                return null;
            }
        } catch (IOException exception) {
            throw new RuntimeException(exception);
