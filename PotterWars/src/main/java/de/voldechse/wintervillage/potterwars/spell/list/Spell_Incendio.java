...
public class Spell_Incendio extends Spell implements Listener {
    ...
    public boolean launchedSpell(Player player) {
        ...
        PotterWars.getInstance().setMetadata(snowball, "INCENDIO", true);
