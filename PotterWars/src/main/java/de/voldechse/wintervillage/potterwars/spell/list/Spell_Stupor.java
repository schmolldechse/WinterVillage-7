...
public class Spell_Stupor extends Spell implements Listener {
    ...
    public boolean launchedSpell(Player player) {
        ...
        PotterWars.getInstance().setMetadata(snowball, "STUPOR", true);
