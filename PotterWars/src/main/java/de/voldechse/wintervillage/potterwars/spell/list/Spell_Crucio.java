...
public class Spell_Crucio extends Spell implements Listener {
    ...
    public boolean launchedSpell(Player player) {
        ...
        PotterWars.getInstance().setMetadata(snowball, "CRUCIO", true);
    ...
    public void execute(ProjectileHitEvent event) {
        ...
        && event.getHitEntity() instanceof Player hitPlayer) {
            ...
            hitPlayer.addPotionEffect(new PotionEffect(PotionEffectType.POISON, 14 * 20, 1));
